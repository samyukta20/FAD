...
#$s=retrive_login('1');
#$s=mysqli_query($con,"select * from upload where app_name = 'Scanner'");
$con=mysqli_connect("localhost","root","");
mysqli_select_db($con,'login');
$res=mysqli_query($con,"select * from upload where app_name = 'Scanner'");
...
$wordminus=array('Abysml','not','wrong','shit','bullshit','low','hell','worst','terrible','bastard','waste','go to hell','bandit','frustating','sad');
$rate=$s['rating']*0.2;
$score=0;
...
if ( $score <= 0 ){
	...
	echo "<script>window.open('scanner.php','_self')</script>";
...
<body>
<div class="bg-img">
  <form action="scanner.php" class="container" method="POST">
